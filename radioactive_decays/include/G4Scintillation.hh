...
class OMSimG4Scintillation : public G4VRestDiscreteProcess
{
 public:
  explicit OMSimG4Scintillation(const G4String& processName = "Scintillation",
...
inline G4bool OMSimG4Scintillation::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline G4bool OMSimG4Scintillation::GetFiniteRiseTime() const
{
  return fFiniteRiseTime;
}

inline G4PhysicsTable* OMSimG4Scintillation::GetIntegralTable1() const
{
  return fIntegralTable1;
}

inline G4PhysicsTable* OMSimG4Scintillation::GetIntegralTable2() const
{
  return fIntegralTable2;
}

inline G4PhysicsTable* OMSimG4Scintillation::GetIntegralTable3() const
{
  return fIntegralTable3;
}

inline void OMSimG4Scintillation::AddSaturation(G4EmSaturation* sat)
{
  fEmSaturation = sat;
}

inline void OMSimG4Scintillation::RemoveSaturation() { fEmSaturation = nullptr; }

inline G4EmSaturation* OMSimG4Scintillation::GetSaturation() const
{
  return fEmSaturation;
}

inline G4bool OMSimG4Scintillation::GetScintillationByParticleType() const
{
  return fScintillationByParticleType;
}

inline G4bool OMSimG4Scintillation::GetScintillationTrackInfo() const
{
  return fScintillationTrackInfo;
}

inline G4bool OMSimG4Scintillation::GetStackPhotons() const { return fStackingFlag; }

inline G4int OMSimG4Scintillation::GetNumPhotons() const { return fNumPhotons; }

inline G4double OMSimG4Scintillation::single_exp(G4double t, G4double tau2)
{
  return std::exp(-1.0 * t / tau2) / tau2;
}

inline G4double OMSimG4Scintillation::bi_exp(G4double t, G4double tau1,
                                        G4double tau2)
{
