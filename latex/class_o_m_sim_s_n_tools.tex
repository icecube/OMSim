...
std\+::vector$<$ G4double $>$ {\bfseries mdompos}
\item 
...
\item[\mbox{\hyperlink{todo__todo000008}{Todo}}]Handle error cases more robustly than just console output. \end{DoxyRefDesc}
\begin{DoxyReturn}{Returns}
