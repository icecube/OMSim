The OMSim-\/\+Framework allows for multi-\/threading. The number of threads can be controlled with the {\ttfamily -\/-\/threads} argument (default 1). If you specify more threads than available, only the maximum available will be used.\hypertarget{md_extra_doc_1_multithreading_autotoc_md13}{}\doxysection{Introduction}\label{md_extra_doc_1_multithreading_autotoc_md13}
...
\end{DoxyItemize}\hypertarget{md_extra_doc_1_multithreading_autotoc_md14}{}\doxysection{Thread Safety Guidelines}\label{md_extra_doc_1_multithreading_autotoc_md14}
...
\end{DoxyEnumerate}\hypertarget{md_extra_doc_1_multithreading_autotoc_md15}{}\doxysection{Thread-\/\+Safe Global Instance Implementation}\label{md_extra_doc_1_multithreading_autotoc_md15}
...
\hypertarget{md_extra_doc_1_multithreading_autotoc_md16}{}\doxysubsection{Example\+: OMSim\+Hit\+Manager}\label{md_extra_doc_1_multithreading_autotoc_md16}
...
\hypertarget{md_extra_doc_1_multithreading_autotoc_md17}{}\doxysubsection{Example\+: Saving Data Per Thread}\label{md_extra_doc_1_multithreading_autotoc_md17}
...
\end{DoxyCode}
\hypertarget{md_extra_doc_1_multithreading_autotoc_md18}{}\doxysection{Best Practices for Creating New Thread-\/\+Safe Containers}\label{md_extra_doc_1_multithreading_autotoc_md18}
...
By following these guidelines and studying the provided examples, you can create thread-\/safe containers and classes for your Geant4 simulations, ensuring proper behavior in multi-\/threaded environments.\hypertarget{md_extra_doc_1_multithreading_autotoc_md19}{}\doxysection{Troubleshooting Multi-\/threading Issues}\label{md_extra_doc_1_multithreading_autotoc_md19}
When developing new code with multi-\/threaded simulations in Geant4, you may encounter race conditions or other thread-\/related issues. Here\textquotesingle{}s a general approach to diagnose and resolve these problems\+:\hypertarget{md_extra_doc_1_multithreading_autotoc_md20}{}\doxysubsection{1. Use Valgrind Tools}\label{md_extra_doc_1_multithreading_autotoc_md20}
...
These tools can identify potential race conditions and other thread-\/related issues. \hypertarget{md_extra_doc_1_multithreading_autotoc_md21}{}\doxysubsection{2. Analyse the Output}\label{md_extra_doc_1_multithreading_autotoc_md21}
...
\end{DoxyItemize}\hypertarget{md_extra_doc_1_multithreading_autotoc_md22}{}\doxysubsection{4. Modify and repeat}\label{md_extra_doc_1_multithreading_autotoc_md22}
