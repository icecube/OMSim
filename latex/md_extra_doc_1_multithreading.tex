The OMSim-\/\+Framework allows for multi-\/threading. The number of threads can be controlled with the {\ttfamily -\/-\/threads} argument (default 1). If you specify more threads than available, only the maximum available will be used.\hypertarget{md_extra_doc_1_multithreading_autotoc_md9}{}\doxysection{Introduction}\label{md_extra_doc_1_multithreading_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{md_extra_doc_1_multithreading_autotoc_md10}{}\doxysection{Thread Safety Guidelines}\label{md_extra_doc_1_multithreading_autotoc_md10}
...
\end{DoxyEnumerate}\hypertarget{md_extra_doc_1_multithreading_autotoc_md11}{}\doxysection{Thread-\/\+Safe Singleton Implementation}\label{md_extra_doc_1_multithreading_autotoc_md11}
...
\hypertarget{md_extra_doc_1_multithreading_autotoc_md12}{}\doxysubsection{Example\+: OMSim\+Hit\+Manager}\label{md_extra_doc_1_multithreading_autotoc_md12}
...
\DoxyCodeLine{    \textcolor{keyword}{static} \mbox{\hyperlink{class_o_m_sim_hit_manager}{OMSimHitManager}}\& getInstance();}
...
\hypertarget{md_extra_doc_1_multithreading_autotoc_md13}{}\doxysubsection{Example\+: Saving Data Per Thread}\label{md_extra_doc_1_multithreading_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{md_extra_doc_1_multithreading_autotoc_md14}{}\doxysection{Best Practices for Creating New Thread-\/\+Safe Containers}\label{md_extra_doc_1_multithreading_autotoc_md14}
...
By following these guidelines and studying the provided examples, you can create thread-\/safe containers and classes for your Geant4 simulations, ensuring proper behavior in multi-\/threaded environments.\hypertarget{md_extra_doc_1_multithreading_autotoc_md15}{}\doxysection{Troubleshooting Multi-\/threading Issues}\label{md_extra_doc_1_multithreading_autotoc_md15}
When developing new code with multi-\/threaded simulations in Geant4, you may encounter race conditions or other thread-\/related issues. Here\textquotesingle{}s a general approach to diagnose and resolve these problems\+:\hypertarget{md_extra_doc_1_multithreading_autotoc_md16}{}\doxysubsection{1. Use Valgrind Tools}\label{md_extra_doc_1_multithreading_autotoc_md16}
...
These tools can identify potential race conditions and other thread-\/related issues. \hypertarget{md_extra_doc_1_multithreading_autotoc_md17}{}\doxysubsection{2. Analyse the Output}\label{md_extra_doc_1_multithreading_autotoc_md17}
...
\end{DoxyItemize}\hypertarget{md_extra_doc_1_multithreading_autotoc_md18}{}\doxysubsection{4. Modify and repeat}\label{md_extra_doc_1_multithreading_autotoc_md18}
