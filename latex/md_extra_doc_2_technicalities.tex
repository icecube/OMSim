...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyEnumerate}\hypertarget{md_extra_doc_2_technicalities_autotoc_md31}{}\doxysection{The Tools namespace}\label{md_extra_doc_2_technicalities_autotoc_md31}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{./OMSim\_efficiency\_calibration -\/-\/pmt\_model 0 -\/-\/simulation\_step 1 -\/n 500000 -\/-\/threads 4 -\/-\/output\_file step1}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{./OMSim\_efficiency\_calibration -\/-\/pmt\_model 0 -\/-\/simulation\_step 2 -\/n 100000 -\/-\/threads 4 -\/-\/output\_file step2}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{./OMSim\_efficiency\_calibration -\/-\/pmt\_model 0 -\/-\/simulation\_step 3 -\/n 10000 -\/-\/threads 4 -\/-\/output\_file step3}
...
\begin{DoxyItemize}
\item Set the photocathode as a 100\% efficient by
\end{DoxyItemize}
