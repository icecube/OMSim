The OMSim-\/\+Framework allows for multi-\/threading. The number of threads can be controlled with the {\ttfamily -\/-\/threads} argument (default 1). If you specify more threads than available, only the maximum available will be used.\hypertarget{md_1_multithreading_autotoc_md9}{}\doxysection{Introduction}\label{md_1_multithreading_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{md_1_multithreading_autotoc_md10}{}\doxysection{Thread Safety Guidelines}\label{md_1_multithreading_autotoc_md10}
...
\end{DoxyEnumerate}\hypertarget{md_1_multithreading_autotoc_md11}{}\doxysection{Thread-\/\+Safe Singleton Implementation}\label{md_1_multithreading_autotoc_md11}
...
\hypertarget{md_1_multithreading_autotoc_md12}{}\doxysubsection{Example\+: OMSim\+Hit\+Manager}\label{md_1_multithreading_autotoc_md12}
...
\hypertarget{md_1_multithreading_autotoc_md13}{}\doxysubsection{Example\+: Saving Data Per Thread}\label{md_1_multithreading_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{md_1_multithreading_autotoc_md14}{}\doxysection{Best Practices for Creating New Thread-\/\+Safe Containers}\label{md_1_multithreading_autotoc_md14}
