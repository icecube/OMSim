...
\begin{DoxyItemize}
\item \href{https://github.com/icecube/OMSim/blob/master/documentation/extra_doc/30_effective_area.md}{\texttt{ Effective area}}\+: calculates the effective area of the optical modules/\+PMTs.
\item \href{https://github.com/icecube/OMSim/blob/master/documentation/extra_doc/31_radioactive_decays.md}{\texttt{ Radioactive decays}}\+: simulates radioactive decays within the glass of the pressure vessel and the PMT glass. Essential for understanding the primary background of optical modules. {\bfseries{Requires Geant4 version 11.\+3.\+0}}
\item \href{https://github.com/icecube/OMSim/blob/master/documentation/extra_doc/32_SN.md}{\texttt{ Supernova studies}}\+: used for the development of an improved SN trigger for Ice\+Cube using multi-\/\+PMT modules.
