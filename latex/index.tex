...
For the latest updates and information, check our \href{https://github.com/icecube/OMSim}{\texttt{ Git\+Hub repository}}. If you need assistance or want to report problems, please open an issue on our Git\+Hub page or contact the maintainers directly.\hypertarget{index_autotoc_md64}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{index_autotoc_md64}
\hypertarget{index_autotoc_md65}{}\doxysubsection{\texorpdfstring{Installing Geant4}{Installing Geant4}}\label{index_autotoc_md65}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md66}{}\doxysubsection{\texorpdfstring{Installing Dependencies}{Installing Dependencies}}\label{index_autotoc_md66}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md67}{}\doxysubsection{\texorpdfstring{Installing ROOT}{Installing ROOT}}\label{index_autotoc_md67}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md68}{}\doxysubsection{\texorpdfstring{Compiling OMSim}{Compiling OMSim}}\label{index_autotoc_md68}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md69}{}\doxysection{\texorpdfstring{Available studies}{Available studies}}\label{index_autotoc_md69}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md70}{}\doxysubsection{\texorpdfstring{Customising Compilation}{Customising Compilation}}\label{index_autotoc_md70}
To exclude certain studies from compilation, edit the {\ttfamily simulations/\+CMake\+Lists.\+tx} file and comment out the unwanted {\ttfamily add\+\_\+subdirectory()} calls before running CMake.\hypertarget{index_autotoc_md71}{}\doxysubsection{\texorpdfstring{Troubleshooting}{Troubleshooting}}\label{index_autotoc_md71}
