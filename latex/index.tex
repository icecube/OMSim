...
{\bfseries{Note\+:}} This project is under active development. If you\textquotesingle{}re interested in using \doxylink{class_o_m_sim}{OMSim}, please contact martin.\+u on IC-\/slack.
...
For the latest updates and information, check our \href{https://github.com/icecube/OMSim}{\texttt{ Git\+Hub repository}}. If you need assistance or want to report problems, please open an issue on our Git\+Hub page or contact the maintainers directly.\hypertarget{index_autotoc_md58}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{index_autotoc_md58}
\hypertarget{index_autotoc_md59}{}\doxysubsection{\texorpdfstring{Installing Geant4}{Installing Geant4}}\label{index_autotoc_md59}

\begin{DoxyEnumerate}
\item Install Geant4 following \href{https://geant4-userdoc.web.cern.ch/UsersGuides/InstallationGuide/html/installguide.html}{\texttt{ the guide provided by CERN}}. \doxylink{class_o_m_sim}{OMSim} is currently optimised for Geant4-\/11 (last tested with 11.\+2.\+2).
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md60}{}\doxysubsection{\texorpdfstring{Installing Dependencies}{Installing Dependencies}}\label{index_autotoc_md60}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md61}{}\doxysubsection{\texorpdfstring{Installing ROOT}{Installing ROOT}}\label{index_autotoc_md61}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md62}{}\doxysubsection{\texorpdfstring{Compiling OMSim}{Compiling OMSim}}\label{index_autotoc_md62}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md63}{}\doxysection{\texorpdfstring{Available studies}{Available studies}}\label{index_autotoc_md63}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md64}{}\doxysubsection{\texorpdfstring{Customising Compilation}{Customising Compilation}}\label{index_autotoc_md64}
