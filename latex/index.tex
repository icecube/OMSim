...
{\bfseries{Note\+:}} This project is under active development. If you\textquotesingle{}re interested in using or contributing to \doxylink{class_o_m_sim}{OMSim}, feel free to join the channel \href{https://icecube-spno.slack.com/archives/C08N2UBPEQG}{\texttt{ OMSim}} on Ice\+Cube-\/slack.
...
For the latest updates and information, check our \href{https://github.com/icecube/OMSim}{\texttt{ Git\+Hub repository}}. If you need assistance or want to report problems, please open an issue on our Git\+Hub page or contact the maintainers directly.\hypertarget{index_autotoc_md82}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{index_autotoc_md82}
\hypertarget{index_autotoc_md83}{}\doxysubsection{\texorpdfstring{Installing Geant4}{Installing Geant4}}\label{index_autotoc_md83}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md84}{}\doxysubsection{\texorpdfstring{Installing Dependencies}{Installing Dependencies}}\label{index_autotoc_md84}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md85}{}\doxysubsection{\texorpdfstring{Installing ROOT}{Installing ROOT}}\label{index_autotoc_md85}

\begin{DoxyEnumerate}
\item Download the latest ROOT binary from \href{https://root.cern/install/all_releases/}{\texttt{ ROOT\textquotesingle{}s official website}} (e.\+g., version 6.\+32.\+08 at the time of writing), or compile from source.
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md86}{}\doxysubsection{\texorpdfstring{Compiling OMSim}{Compiling OMSim}}\label{index_autotoc_md86}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md87}{}\doxysection{\texorpdfstring{Available studies}{Available studies}}\label{index_autotoc_md87}
...
\item \href{https://icecube.github.io/OMSim/md_extra__doc_233__wavepid.html}{\texttt{ Wave\+PID}}\+: simulates a charged particle track (typically a muon) passing an Ice\+Cube optical module at a configurable impact parameter, records each detected photon\textquotesingle{}s arrival time and origin, and produces the photon arrival time distributions used in the Wave\+PID particle identification method.
\end{DoxyItemize}\hypertarget{index_autotoc_md88}{}\doxysubsection{\texorpdfstring{Customising Compilation}{Customising Compilation}}\label{index_autotoc_md88}
To exclude certain studies from compilation, edit the {\ttfamily simulations/\+CMake\+Lists.\+tx} file and comment out the unwanted {\ttfamily add\+\_\+subdirectory()} calls before running CMake.\hypertarget{index_autotoc_md89}{}\doxysubsection{\texorpdfstring{Troubleshooting}{Troubleshooting}}\label{index_autotoc_md89}
...
\DoxyCodeLine{[\ \ 2\%]\ Linking\ CXX\ executable\ ../../OMSim\_effective\_area}
\DoxyCodeLine{/usr/bin/ld:\ warning:\ libtbb.so.2,\ needed\ by\ ...}

\end{DoxyCode}


you can resolve this by installing {\ttfamily libtbb2}\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{sudo\ apt\ install\ libtbb2}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{mv\ /path/to/anaconda3\ /path/to/anaconda3\_temp}

\end{DoxyCode}


Check carefully your {\ttfamily cmake ..} and {\ttfamily make} output to identify and resolve potential issues and consult your system administrator if applicable. Please note that we cannot guarantee full support for all system configurations. 